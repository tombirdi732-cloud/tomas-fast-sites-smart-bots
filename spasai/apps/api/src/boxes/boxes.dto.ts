...
export class SearchBoxesDto {
  ...
  @Type(() => Number)
  /**
   * Радиус в метрах. Без него поиск не ограничен расстоянием: лента
   * показывает ближайшее сверху, а дальнее — следом, вместо пустого
   * экрана в городе, где заведений пока мало.
   */
  @IsInt()
  @Min(100)
  @Max(20_000_000)
