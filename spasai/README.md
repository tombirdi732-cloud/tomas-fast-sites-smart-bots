...
- **[docs/development.md](docs/development.md)** — что поставить, как
  редактировать, как собрать APK и подписать его для RuStore;
- **[docs/server.md](docs/server.md)** — команды сервера: обновление,
  перезапуск, логи;
- **[docs/store/README.md](docs/store/README.md)** — скриншоты и тексты
  для карточки в магазине приложений.
